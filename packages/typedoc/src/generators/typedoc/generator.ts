...
interface NormalizedSchema extends TypedocGeneratorSchema {
  projectName: string
  projectRoot: string
...
function normalizeOptions(tree: Tree, options: TypedocGeneratorSchema): NormalizedSchema {
...
export default async function (tree: Tree, options: TypedocGeneratorSchema) {
  ...
  addProjectConfiguration(tree, normalizedOptions.projectName, {
    ...
    targets: {
      build: {
        executor: '@enio.ai/typedoc:build'
      }
    },
